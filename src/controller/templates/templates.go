...
func GetByName(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Failed to get template: %s", err.Error())
		ginx.Dangerous(err)
	}
...
func Page(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Page transform failed: %s", err.Error())
		ginx.Dangerous(err)
	}
	pageSize, err := strconv.Atoi(size)
	if err != nil {
		logger.Log.Errorf("PageSize transform failed: %s", err.Error())
		ginx.Dangerous(err)
	}
	templatePage, err := templatesController.TemplatesService.Page(pageNum, pageSize)
	if err != nil {
		logger.Log.Errorf("Get template list failed: %s", err.Error())
		ginx.Dangerous(err)
	}
...
func Save(ctx *gin.Context) {
	...
	if err := ctx.ShouldBind(&template); err != nil {
		logger.Log.Errorf("Template Info bind failed: %s", err.Error())
		ginx.Dangerous(err)
	}
	err := templatesController.TemplatesService.Save(template)
	if err != nil {
		logger.Log.Errorf("Template info save failed: %s", err.Error())
		ginx.Dangerous(err)
	}
	ginx.NewRender(ctx).Data(template, nil)
}
...
func Update(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Template info update failed: %s", err.Error())
		ginx.Dangerous(err)
	}
	ginx.NewRender(ctx).Data(template, nil)
}
...
func Delete(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Template info delete failed: %s", err.Error())
		ginx.Dangerous(err)
	}
...
func Batch(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Template info operate failed: %s", err.Error())
		ginx.Dangerous(err)
	}
	ginx.NewRender(ctx).Data(nil, nil)
}
