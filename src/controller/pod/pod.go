...
func GetPods(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Get pod list failed: %s", err.Error())
		ginx.Dangerous(err)
	}
...
func GetPodStatus(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Get pod status failed: %s", err.Error())
		ginx.Dangerous(err)
	}
...
func GetPodsStatus(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Get pod list status failed: %s", err.Error())
		ginx.Dangerous(err)
	}
	ginx.NewRender(ctx).Data(status, nil)
