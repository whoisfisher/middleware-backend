...
func Get(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("User info get failed: %s", err.Error())
		ginx.Dangerous(err)
	}
...
func Create(ctx *gin.Context) {
	...
	if err := ctx.ShouldBind(&usr); err != nil {
		logger.Log.Errorf("Failed to bind Userinfo: %s", err.Error())
		ginx.Dangerous(err)
	}
	usr1, err := userController.UserService.Create(usr)
	if err != nil {
		logger.Log.Errorf("Failed to create user: %s", err.Error())
		ginx.Dangerous(err)
	}
...
func Update(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Failed to update Userinfo: %s", err.Error())
		ginx.Dangerous(err)
	}
	ginx.NewRender(ctx).Data(usr1, nil)
}
...
func Delete(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Failed to delete Userinfo: %s", err.Error())
		ginx.Dangerous(err)
	}
...
func Batch(ctx *gin.Context) {
	...
	if err != nil {
		logger.Log.Errorf("Failed to operator Userinfo: %s", err.Error())
		ginx.Dangerous(err)
	}
	ginx.NewRender(ctx).Data(nil, nil)
}
...
func ChangePassword(ctx *gin.Context) {
	...
	if err := userController.UserService.ChangePassword(usr); err != nil {
		logger.Log.Errorf("Failed to change password: %s", err.Error())
		ginx.Dangerous(err)
	}
	ginx.NewRender(ctx).Data(nil, nil)
}
